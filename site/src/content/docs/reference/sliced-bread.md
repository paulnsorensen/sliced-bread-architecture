---
title: 'Sliced Bread: Rationale & Anti-Patterns'
description: Why vertical slices, why organic growth, the anti-patterns, and the boundary decisions.
---

This page publishes `reference/sliced-bread.md`, the sole authority for the rules, severities, and growth outcomes. Every consumer must preserve the relevant marker-fenced blocks verbatim. `reference/doctrine-contracts.json` is the executable projection and may not override the reference.
